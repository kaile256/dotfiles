...
c.colors.downloads.stop.fg = WHITE_2
c.colors.downloads.stop.bg = BLACK_0
...
c.colors.tabs.odd.bg = WHITE_0
c.colors.tabs.even.bg = WHITE_2
c.colors.tabs.pinned.odd.bg = WHITE_0
c.colors.tabs.pinned.even.bg = WHITE_2
