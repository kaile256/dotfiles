# -*- coding: utf-8 -*-
# Copied from: /usr/share/doc/qtile/default_config.py
...
keys = [
    ...
    Key([mod], "Return", lazy.spawn("dmenu-desktop")),
    ...
    # Apps hotkeys
    Key([mod], "u", lazy.spawn("urxvt")),
    Key([mod], "t", lazy.spawn("qterminal")),

    # Hotkey; Editor
    #Key([mod], "g", lazy.spawn("gnvim")),
    ...
    # System hotkeys
    Key([mod, "shift", "control"], "F11",
        lazy.spawn("sudo hibernate-reboot")),
