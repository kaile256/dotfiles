...
let g:table_mode_realign_map = '<Ignore>'
let g:table_mode_delete_row_map = '<Ignore>'
let g:table_mode_delete_column_map = '<Ignore>'
let g:table_mode_add_formula_map = '<Ignore>'
