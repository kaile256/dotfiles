...
" use `0i` for `gI` though it is not dot-repeatable.
nnoremap <silent> gI :<C-u>call CocActionAsync('jumpImplementation', 'edit')<CR>
...
nnoremap <silent> <C-w>I :<C-u>call CocActionAsync('jumpImplementation', 'split')<CR>
...
nnoremap <silent> <C-w>gI :<C-u>call CocActionAsync('jumpImplementation', 'tabe')<CR>
...
nnoremap <silent> <C-w><space>I :<C-u>call CocActionAsync('jumpImplementation', 'vsplit')<CR>
