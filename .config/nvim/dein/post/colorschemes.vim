...
augroup myColorschemesAdjustment "{{{1
  if exists('#myColorschemesAdjustment') | au! myColorschemesAdjustment
  endif
  au Colorscheme *       call s:my_commons()
  au Colorscheme neodark call s:my_neodark()
  function! s:my_commons() abort "{{{2
...
" Overwrite config out of the augroup, too {{{1
call s:my_commons()
