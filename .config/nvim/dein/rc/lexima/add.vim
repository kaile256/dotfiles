...
inoremap <expr> <C-0>   pumvisible() ? '<Cmd>setlocal pumblend=0<CR>'   : lexima#expand('<C-0>',   'i')
inoremap <expr> <C-S-_> pumvisible() ? '<Cmd>setlocal pumblend=100<CR>' : lexima#expand('<C-S-_>', 'i')

nnoremap <C--> <Cmd>setlocal winblend+=5<CR>
nnoremap <C-+> <Cmd>setlocal winblend-=5<CR>
nnoremap <C-=> <Cmd>call <SID>reset_to_default("winblend")<CR>

nnoremap <C-0>   <Cmd>setlocal winblend=0<CR>
nnoremap <C-S-_> <Cmd>setlocal winblend=100<CR>
