...
augroup myMarkdowndPreview
  ...
  au BufEnter *.{md,mkd,markdown,mdown,mkdn,mdwn} command! -buffer Preview :MarkdownPreview
  au BufEnter *.{md,mkd,markdown,mdown,mkdn,mdwn} command! -buffer Stop    :MarkdownPreviewStop
