...
command! -bar -bang -nargs=? -complete=dir Gfiles
...
"      \                         : fzf#vim#with_preview({'prefix': "'.git/", 'options': '--multi --reverse'}, 'right:50%'),
"      \                 <bang>0)
command! -bar -bang -nargs=* Helptags call fzf#vim#helptags({'options': '--multi --reverse'}, <bang>0)
"}}}
