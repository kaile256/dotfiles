...
cnoreabbr <expr> teb (getcmdtype() == ':' && getcmdline() =~ '^teb$')? 'tab sp <bar> Deol' : 'teb'
cnoreabbr <expr> tes (getcmdtype() == ':' && getcmdline() =~ '^tes$')? 'sp <bar> Deol' : 'tes'
cnoreabbr <expr> tev (getcmdtype() == ':' && getcmdline() =~ '^tev$')? 'vs <bar> Deol' : 'tev'
