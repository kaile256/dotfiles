...
noremap <silent> <a-q><a-c> :<c-u> cd ~/.cache      <cr> :FZF<cr>
noremap <silent> <a-q>c     :<c-u> cd ~/.cache      <cr> :FZF<cr>
...
augroup FzfAutoToggle
  au!
  au FileType fzf setl laststatus=0 noruler | au BufRead * ++once setl laststatus=2 ruler
augroup END
