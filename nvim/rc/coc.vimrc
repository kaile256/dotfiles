...
" CocList; Jump {{{1
"" Jump; as :edit {{{2
nmap <silent> gd :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-definition)
xmap <silent> gd :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-definition)
nmap <silent> gD :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-declaration)
xmap <silent> gD :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-declaration)
nmap <silent> gI :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-implementation)
xmap <silent> gI :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-implementation)
nmap <silent> gy :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-type-definition)
xmap <silent> gy :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-type-definition)
nmap <silent> gr :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-references)
xmap <silent> gr :call coc#config("coc.preferences", {"jumpCommand": "open"})<cr><Plug>(coc-references)
"" Jump; as :vsplit {{{2
